...
<div class="col-xs-12">
  <div id="footer">
    ...
    <div class="contact-container">
      <a href="tel:+6045677890">604.567.7890</a>
      <p>157 Water St.</p>
      <p>Vancouver, BC</p>
    </div>

    <div class="credit-container">
      <p>2017 &copy; Social or Nothing</p>
      <p>Web Design by <a href="http://www.pivotandpilot.com">Pivot & Pilot</a></p>
    </div>

    <div class="emblem-container">
      <img class="img-responsive" src="<?php echo get_template_directory_uri() . '/dist/img/emblem.png' ?>"/>
    </div>
